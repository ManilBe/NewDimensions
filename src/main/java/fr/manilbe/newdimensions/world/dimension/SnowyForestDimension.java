...
package fr.manilbe.newdimensions.world.dimension;
...
import fr.manilbe.newdimensions.item.SnowyForestItem;
import fr.manilbe.newdimensions.NewDimsElements;

import com.google.common.collect.Sets;
import com.google.common.collect.ImmutableSet;
import com.google.common.cache.LoadingCache;

@NewDimsElements.ModElement.Tag
public class SnowyForestDimension extends NewDimsElements.ModElement {
	@ObjectHolder("newdims:snowy_forest")
	public static final ModDimension dimension = null;
	@ObjectHolder("newdims:snowy_forest_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public SnowyForestDimension(NewDimsElements instance) {
		super(instance, 2);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("snowy_forest"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("newdims:snowy_forest")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("newdims:snowy_forest"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("newdims:snowy_forest"));
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new SnowyForestItem().setRegistryName("snowy_forest"));
	}
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("snowy_forest_portal");
		}
		...
		private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
			BlockPattern.PatternHelper bph = SnowyForestDimension.CustomPortalBlock.createPatternHelper(entity.world, new BlockPos(pos));
	...
	public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
		try {
			...
			poi = (PointOfInterestType) method.invoke(null, "snowy_forest_portal",
	...
	public static class TeleporterDimensionMod extends Teleporter {
		...
		public BlockPattern.PortalInfo placeInExistingPortal(BlockPos p_222272_1_, Vec3d p_222272_2_, Direction directionIn, double p_222272_4_,
			...
			return optional.map((p_226707_7_) -> {
				...
				BlockPattern.PatternHelper blockpattern$patternhelper = SnowyForestDimension.CustomPortalBlock.createPatternHelper(this.world,
						blockpos);
